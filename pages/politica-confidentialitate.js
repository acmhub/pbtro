...
const privacyData = [
    ...
    {
        title: 'purpose.title',
        description: ['purpose.desc1', 'purpose.desc2', 'purpose.desc3', 'purpose.desc4', 'purpose.desc5']
    },
    {
    ...
    {
        title: 'reveal.title',
        description: ['reveal.desc1', 'reveal.desc2', 'reveal.desc3', 'reveal.desc4']
    }
];
...
export default function PoliticaCookies() {
    ...
    return (
        <Layout pageID="privacy" title={t('common:privacypolicy')}>
            <div className="section-spacing-lg" />

            <div className="container-padding">
                <h1 className="text-center mb-20">{t('common:privacypolicy')}</h1>
                ...
                <div className="divide-y lg:max-w-5xl lg:mx-auto">
                    ...
                    <div className="space-y-2 py-6">
                        ...
                        <div>
                            ...
                            <div className="pl-4">
                                <p className="text-indent">{t('rights.extradesc6')}</p>
                                <p className="text-indent">{t('rights.extradesc7')}</p>
                                <p className="text-indent">{t('rights.extradesc8')}</p>
                                <p className="text-indent">{t('rights.extradesc9')}</p>
                                <p className="text-indent">{t('rights.extradesc10')}</p>
                                <p className="text-indent">{t('rights.extradesc11')}</p>
                            </div>

                            <p className="text-indent">{t('rights.desc11')}</p>
                            <p className="text-indent">{t('rights.desc12')}</p>
                            <div className="pl-4">
                                <p className="text-indent">{t('rights.extradesc14')}</p>
                                <p className="text-indent">{t('rights.extradesc15')}</p>
                                <p className="text-indent">{t('rights.extradesc16')}</p>
                                <p className="text-indent">{t('rights.extradesc17')}</p>
                            </div>

                            <p className="text-indent">{t('rights.desc18')}</p>
                            <p className="text-indent">{t('rights.desc19')}</p>
                            <div className="pl-4">
                                <p className="text-indent">{t('rights.extradesc20')}</p>
                                <p className="text-indent">{t('rights.extradesc21')}</p>
                            </div>
