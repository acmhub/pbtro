...
const cookiesDisclaimer = [
    ...
    {
        title: 'usage',
        description: ['usagedesc1', 'usagedesc2', 'usagedesc3', 'usagedesc4', 'usagedesc5']
    },
    {
        title: 'duration',
    ...
    {
        title: 'disable',
        description: ['disabledesc1', 'disabledesc2', 'disabledesc3', 'disabledesc4']
    }
];
...
export default function PoliticaCookies() {
    ...
    return (
        <Layout pageID="cookies" title={t('common:cookiespolicy')}>
            <div className="section-spacing-lg" />

            <div className="container-padding">
                <h1 className="text-center mb-20">{t('common:cookiespolicy')}</h1>
