...
export default function GetQuote() {
    ...
    const [modalState, setModalState] = useState({ state: false, product: null });
    ...
    return (
        <Layout pageID="getquote" title={t('common:getquote')} description={t('description')}>
            ...
            <div className="container-padding">
                    ...
                    <div className="col-span-1 lg:col-span-9">
                        ...
                        {!selectedProduct ? (
                            <div className="flex flex-col items-center justify-center h-full space-y-4">
                                ...
                                <h4 className="text-center">{t('emptyorder')}</h4>
                            </div>
                        ) : (
                                    ...
                                    <div className="flex w-full justify-between items-center pr-6">
                                        ...
                                        <div className="space-x-4">
                                            <Tooltip title={<h6>{t('edit')}</h6>} placement="top">
                                                <button
                                                    className="p-1"
                                                    onClick={() => setModalState({ state: true, product: e })}
                                                >
                                                    <span className="material-symbols-outlined text-theme1">edit</span>
                                                </button>
                                            </Tooltip>
                                            <Modal
                                                ...
                                                onClose={() => setModalState({ state: false, product: null })}
                ...
                {state?.quote?.quoteItems?.length > 0 && (
                    <form onSubmit={handleQuoteSubmit} className="card space-y-2 mt-20">
                        <TextField name="Nume" label={t('Nume')} variant="standard" fullWidth required />
                        <div className="grid grid-cols-1 lg:grid-cols-2 gap-2">
                            <TextField name="Email" label="Email" variant="standard" fullWidth required />
                            <TextField
                        ...
                        <TextField name="Locatie" label={t('Locatie')} variant="standard" fullWidth required />
