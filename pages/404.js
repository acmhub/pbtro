...
export default function GetQuote() {
    ...
    return (
        <Layout pageID="notfound" title={t('common:notfound')}>
            ...
            <div className="container-padding space-y-10">
                <div className="grid grid-cols-1 lg:grid-cols-12 gap-8">
                    ...
                    <div className="col-span-1 lg:col-span-8 text-center lg:text-left my-auto">
                        <h1 className="text-9xl">404</h1>
                        <h2>{t('common:notfound')}</h2>
                        <p>
                            Lorem ipsum dolor sit amet consectetur adipisicing elit. Non doloribus atque accusamus
                            suscipit nam commodi.
                        </p>
                    </div>
                </div>

                <Link href="/" passHref>
                    <a className="theme-button1 block w-fit mx-auto">Inapoi la prima pagina</a>
                </Link>
            </div>
