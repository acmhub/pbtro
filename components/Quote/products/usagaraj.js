...
export default function UsaGaraj({ handleAddProduct, handleModifyProduct, modifying, t }) {
    const [color, setColor] = useState('');

    return (
        <form onSubmit={modifying ? handleModifyProduct : handleAddProduct} className="space-y-4">
            <input type="text" name="Produs" value="Usa Garaj" className="hidden" readOnly />
