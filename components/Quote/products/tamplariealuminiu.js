...
export default function TamplarieAluminiu({ handleAddProduct, handleModifyProduct, modifying, t }) {
    const [profileType, setProfileType] = useState('');
    const [color, setColor] = useState('');

    return (
        <form onSubmit={modifying ? handleModifyProduct : handleAddProduct} className="space-y-4">
            <input type="text" name="Produs" value="Tamplarie Aluminiu" className="hidden" readOnly />
