    ...
    return (
        <div className="container-padding space-y-10">
            ...
            <div className="grid grid-cols-1 lg:grid-cols-12 gap-10">
                    ...
                    <div className="grid grid-cols-1 lg:grid-cols-3 gap-10">
                        <div>
                            <div className="flex items-center space-x-2 mb-2">
                                <div className="bg-theme2 w-fit rounded-lg p-2">
                        ...
                        <div>
                            <div className="flex items-center space-x-2">
                                <div className="bg-theme2 w-fit rounded-lg p-2 mb-2">
                ...
                <form onSubmit={handleSubmit} className="card col-span-1 lg:col-span-4 space-y-6">
                    ...
                    <div className="flex items-center justify-between space-x-4 pt-4">
                        <div className="flex items-center space-x-2">
                            <Checkbox value={consent} onChange={(e) => setConsent(e.target.checked)} className="p-0" />
                            <div>
                                Sunt de acord cu{' '}
                                <Link href="/" passHref>
                                    <a className="text-sky-800 underline opacity-100 hover:opacity-75">
